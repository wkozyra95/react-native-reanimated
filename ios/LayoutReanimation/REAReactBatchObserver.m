...
- (void)uiManagerWillPerformMounting:(RCTUIManager *)uiManager
{
  ...
  void (^goThroughAffectedWithBlock)(
      NSDictionary<NSNumber *, UIView *> *viewRegistry, void (^)(REAAnimationRootView *view, NSNumber *)) =
      ^void(NSDictionary<NSNumber *, UIView *> *viewRegistry, void (^block)(REAAnimationRootView *view, NSNumber *)) {
        for (NSNumber *tag in affectedAnimationRootsTags) {
          UIView *view = viewRegistry[tag];
          RCTAssert(
              view == nil || [view isKindOfClass:[REAAnimationRootView class]],
              @"View is not a subclass of REAAnimationRootView");
  ...
  [self.uiManager prependUIBlock:^(RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ...
    void (^block)(REAAnimationRootView *, NSNumber *) = ^void(REAAnimationRootView *view, NSNumber *tag) {
      ...
      [REAViewTraverser traverse:view
